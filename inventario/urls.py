...
urlpatterns = [
    ...
    path("sondas/<int:pk>/excluir/", views.excluir_sonda_remota, name="sonda_excluir"),
    ...
    path("tipos/<int:pk>/excluir/", views.excluir_tipo_ativo, name="tipo_excluir"),
    ...
    path("snmp/<int:pk>/excluir/", views.excluir_credencial_snmp, name="snmp_excluir"),
    ...
    path("faixas/<int:pk>/excluir/", views.excluir_faixa_rede, name="faixa_excluir"),
    ...
    path("agendamentos/<int:pk>/excluir/", views.excluir_agendamento_varredura, name="agendamento_excluir"),
]
