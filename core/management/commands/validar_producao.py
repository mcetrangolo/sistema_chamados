...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        verificacoes = [
            ...
            ("ALLOWED_HOSTS sem wildcard", "*" not in settings.ALLOWED_HOSTS, True),
            ("CSRF_TRUSTED_ORIGINS configurado", bool(settings.CSRF_TRUSTED_ORIGINS), False),
            ...
            ("SESSION_COOKIE_SECURE=True", settings.SESSION_COOKIE_SECURE is True, False),
            ("CSRF_COOKIE_SECURE=True", settings.CSRF_COOKIE_SECURE is True, False),
            ("SECURE_SSL_REDIRECT=True", settings.SECURE_SSL_REDIRECT is True, False),
            ("BACKUP_ENCRYPTION_KEY configurada", bool(settings.BACKUP_ENCRYPTION_KEY), False),
