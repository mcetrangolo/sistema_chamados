...
urlpatterns = [
    ...
    path("usuarios/<int:pk>/senha/", views.alterar_senha_usuario, name="usuario_senha"),
    path("usuarios/<int:pk>/status/", views.alternar_status_usuario, name="usuario_status"),
    path("usuarios/<int:pk>/excluir/", views.excluir_usuario, name="usuario_excluir"),
